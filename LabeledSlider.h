...
public:
    ...
    {
        slider.setColour(Slider::trackColourId, Colour::fromRGB(200, 200, 200));
        sliderLabel.setText(text, dontSendNotification);
        sliderLabel.setColour(Label::textColourId,Colour::fromRGB(0, 0, 0));
        Typeface::Ptr typeface = Typeface::createSystemTypefaceFor(BinaryData::papyrus_ttf, BinaryData::papyrus_ttfSize);
        sliderLabel.setFont(typeface);
    }
